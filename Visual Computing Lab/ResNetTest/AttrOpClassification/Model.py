...
# =============================================================================
    ...
    def val_forward(self, img, obj_label, attr_label):
        ...
        attrs, objs = list(set(self.attrsP)), list(set(self.objsP)) ## Fix this
        ...
        attrSize = len(attrs) 
        objSize = len(objs)
        dists = torch.zeros((attrSize,objSize)) #  np.zeros((attrSize,objSize))
    ...
    def val_forwardP(self, img, obj_label, attr_label):
        ...
        img_feat = self.image_embedder(img)
        attrs, objs = list(set(self.attrsP)), list(set(self.objsP))

        attrSize = len(attrs) 
        objSize = len(objs)
        dists = torch.zeros((attrSize,objSize))
